...
INSERT INTO "new_ProductSupply" ("alternativeSkuId", "costFils", "createdAt", "id", "isAvailable", "leadTimeDays", "rank", "skuId", "supplierId", "supplierPartNumber", "supplyStatus", "updatedAt") SELECT "alternativeSkuId", "costFils", "createdAt", "id", "isAvailable", "leadTimeDays", "rank", "skuId", "supplierId", "supplierPartNumber", "supplyStatus", "updatedAt" FROM "ProductSupply";
