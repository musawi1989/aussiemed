...
export const TONES: Record<Tone, ToneMeta> = {
  resting: {
    ...
    pill: "bg-surface-sunken text-text-muted ring-1 ring-inset ring-border-base",
  ...
  active: {
    ...
    pill: "bg-navy-soft text-navy ring-1 ring-inset ring-navy-border",
    text: "text-navy",
    rail: "bg-navy",
    dot: "bg-navy",
  },
  attention: {
    ...
    pill: "bg-accent-soft text-accent ring-1 ring-inset ring-accent-border",
    text: "text-accent",
    rail: "bg-accent",
    dot: "bg-accent",
  },
  complete: {
    ...
    pill: "bg-success-soft text-success ring-1 ring-inset ring-success/30",
    text: "text-success",
    rail: "bg-success",
    dot: "bg-success",
  },
  stopped: {
    ...
    pill: "bg-danger-soft text-danger ring-1 ring-inset ring-danger/30",
    text: "text-danger",
    rail: "bg-danger",
    dot: "bg-danger",
  },
